// Add tests on lines #68, #91, #95, #142, #146, #151, #155, #161, and #205
...
describe("controller", function() {
  ...
  describe("routing", function() {
    ...
    it("should show completed entries", function() {
      // TODO: write test
      const todo = { title: "my amazing todo" };
  ...
  it('should highlight "All" filter by default', function() {
    // TODO: write test
    const todo = { id: 42, title: "todo", complete: false };
  ...
  describe("toggle all", function() {
    it("should toggle all todos to completed", function() {
      // TODO: write test
      const todos = [
        { id: 42, title: " first todo", complete: false },
        { id: 43, title: "second todo", complete: false },
        { id: 44, title: " third todo", complete: false }
      ];
